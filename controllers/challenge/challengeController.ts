...
export const joinMatchmaking = catchAsync(
...
export const getChallengeStatus = catchAsync(
    async (req: IBaseRequest, res: Response, next: NextFunction) => {
        try {
...
export const leaveMatchmaking = catchAsync(
    async (req: IBaseRequest, res: Response, next: NextFunction) => {
        try {
            ...
            return res.status(200).json({ message: "Left matchmaking successfully." });
        } catch (error) {
...
export const drawChallenge = catchAsync(
    async (req: IBaseRequest, res: Response, next: NextFunction) => {
        try {
...
export const submitChallengeResult = catchAsync(
    async (req: IBaseRequest, res: Response, next: NextFunction) => {
        try {
